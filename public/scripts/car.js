class Car {
    ...
    render() {
      return `
        <div class="carCard" style="background-color: whitesmoke;" style:"height:584px;">
            <div class="card__content d-flex flex-column shadow">
              <div>
                <img src="${this.image}" alt="" style="height:222px; width:100%; object-fit: cover;">
              </div>
            <div class="d-flex flex-column">
              <p class="paragraph-font" style="margin-bottom: 8px;">${this.manufacture} ${this.model} / ${this.type}</p>
              <p class="title-card" style="margin-bottom: 8px;">${this.rentPerDay} / hari</p>
              <p class="paragraph-font" style="margin-bottom: 8px;">${this.description}</p>
            </div>
            <div class="cardFitur d-flex flex-column">
              <div class="car-capasity d-flex flex-row">
                ...
                <p class="paragraph-font" style="margin-left: 8px;">${this.capacity}</p>                
              </div>
              <div class="car-type d-flex flex-row">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p class="paragraph-font" style="margin-left: 8px;">${this.transmission}</p>  
              </div>
              <div class="car-year d-flex flex-row">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p class="paragraph-font" style="margin-left: 8px;">${this.year}</p>  
              </div>
            </div>
            <button class="button" type="submit">Pilih Mobil</button>
            </div>
          </div>
      `;
    }
